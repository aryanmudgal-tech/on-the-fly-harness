...
- **2026 was brutal for standalone harness companies.** Terragon shut down (announced January 16, service ended February 9, 2026), Bloop shut down and left Vibe Kanban to the community (April 2026), Roo Code killed its 24k-star VS Code extension to bet on a Slack-first cloud agent (May 2026), and Cursor absorbed Continue (June 2026), days before SpaceX agreed to buy Cursor itself for $60B (announced June 16, closed August 14, 2026). Amp launched ad-supported coding (October 2025) and abandoned ads within five months (March 2026).
- **Model dependence is the hidden risk.** Almost every independent harness is model-agnostic on paper, but Anthropic's April 4, 2026 rule barring third-party harnesses from Claude Pro/Max subscriptions (partly reversed from June 15, 2026 through capped "Agent SDK credits") showed a provider can change a harness's unit economics overnight. Only Cursor and Cognition ship their own models, and Cursor's Composer 2 turned out to be post-trained on Moonshot's Kimi K2.5.
...
- **Business and status.** Closed source; subscription tiers reported as Hobby (free), Pro $20, Pro+ $60, Ultra $200, Teams $40/user, Enterprise (secondary, [10]). Cursor acquired Continue in mid-June 2026 (reported as June 16; The New Stack, [12]). On June 16, 2026 SpaceX announced it would acquire Anysphere for $60B in an all-stock deal, days after SpaceX's IPO; the deal closed on August 14, 2026 (roughly 391 million SpaceX Class A shares, described as the largest startup acquisition on record) and Cursor now operates as a wholly owned subsidiary inside SpaceX's AI division (CNBC, June 16, 2026; Yahoo Finance and Techzine, August 2026; SatNews, August 13, 2026 [95]).
...
- **Business.** Closed source. Reported Devin Desktop tiers: Free, Pro $20, Max $200, Teams, Enterprise (secondary, [14]). Cognition raised over $1B at a $26B post-money valuation in May 2026 (TechCrunch, May 27, 2026, [17]); TechCrunch and The Next Web reported annualised revenue of $492M at the time of the round, up from $37M a year earlier ([17], [18]); TechCrunch reported in August 2026 that it was in talks at a $40B valuation ([19]).
...
- **Models and business.** 500+ models through Kilo's gateway "at the model provider's rate with zero markup" ([25]); revenue comes from the gateway and cloud. An $8M seed round led by Cota Capital (with Breakers, General Catalyst, Quiet Capital and Tokyo Black) was announced December 10, 2025; the company was co-founded by Scott Breitenother (CEO) and GitLab co-founder Sid Sijbrandij (CNBC, December 10, 2025 [96]; [27]).
...
- **Business.** Free OSS plus teams/enterprise plans; $32M in combined seed and Series A funding co-led by Emergence Capital and Pace Capital, announced July 2025 (Cline blog and FinSMEs, July 2025 [97]).

### Roo Code (shut down) and Roomote

- Apache-2.0, ~24k stars. The README states the extension "was shut down on May 15th" 2026 and points users to the community fork ZooCode and to Cline ([30]). The team announced the sunset on April 21, 2026 (the "sunsetting Roo Code extension, cloud and router" blog post was merged into the repository that day; the repository itself was archived May 15, 2026), saying it did not believe IDEs are the future of coding, and pivoted to *Roomote*, a cloud agent driven from Slack, GitHub and Linear that runs and verifies code before handing back a PR; as of May 2026 it had no public release (secondary, [31]).
...
- **Business.** Closed core, usage credits; funding figures circulating ($270M round, $472M total) are **unverified**; what can be confirmed is a $227M Series B at a $977M post-money valuation (April 2024, $252M raised in total at that point, per Augment's own announcement), and a later round reported by Dealroom as $200M at a $1.4B valuation (date and terms unverified).
- **Distinctive.** Sells the context engine as a component to competitors' harnesses.

### Continue (acquired)

- Apache-2.0, ~36k stars. A YC S23 company that pivoted in 2025 to "Continuous AI" (a `cn` CLI and PR checks defined in markdown). Cursor acquired it in mid-June 2026 (reported as June 16); the repository is now read-only after a final 2.0.0 release that removed telemetry and authentication (tags v2.0.0-vscode and v2.1.0-vscode, both June 19, 2026); users had until July 15, 2026 to export data, when the hosted Hub shut down ([12], [35]).
...
- **Business experiments.** Amp Free launched in October 2025 with a daily credit grant paid for by ads inside the agent's output, and Amp reportedly said ad sales reached a $10M+ annual run rate (unverified); in March 2026 Amp removed the ads, reportedly because, after the late-2025 releases of Gemini 3 Pro, Opus 4.5 and GPT-5.2 Codex, "ads don't pay for enough frontier tokens to make a difference" (the removal is corroborated by search excerpts of [39]; the run-rate figure and the quote could not be checked because ampcode.com was unreachable) ([38], [39]). Paid use is pay-as-you-go without markup; a $10/month student tier was announced in 2026 ([40]).
...
- **Evidence claim.** A Databricks internal benchmark, built from tasks on its own multi-million-line codebase, found pi had the highest pass rate of any harness tested on a top-tier Anthropic model (search excerpts name Claude Opus 4.8 at the highest thinking effort) at markedly lower cost than Claude Code and Codex, more than 2x cheaper per task in some comparisons, because it sent roughly 3x less context per turn and finished in fewer runs (Databricks Engineering blog, "Benchmarking Coding Agents on Databricks' Multi-Million Line Codebase", and Earendil, "Pi, Minimal and Performant" [98]; neither page could be opened from this environment, so the figures rest on four independent search excerpts; see also [49]).
...
| **Replit Agent 4** | Browser workspace on Replit's cloud; Agent 4 (March 11, 2026) adds parallel tasks, design control and outputs beyond code: mobile apps, presentations, data visualisations ([61], [62]) | Multiple frontier models (unverified) | Subscription plus effort-based billing; closed | $400M Series D at a $9B valuation led by Georgian, March 11, 2026 (Replit announcement; [63]); ARR was reported at $240M at the time of the raise, with a $1B target for end-2026; the ~$525M mid-2026 figure is secondary and **unverified** |
| **Bolt (StackBlitz)** | In-browser Node runtime (WebContainers); an MIT open-source `bolt.new` repo (~17k stars) underlies the hosted product ([64]) | Claude by default; a "Claude Agent" became the default agent in August 2026 (secondary, [65]) | Subscription; enterprise via AWS and, since May 2026, Microsoft marketplaces (secondary, [65]) | ~$40M ARR by March 2025, five months after its October 2024 launch (secondary [66], corroborated by several independent write-ups) |
| **v0 (Vercel)** | Browser builder that deploys to Vercel; sandboxes | Vercel composite model plus frontier models (unverified for 2026) | Credits; closed | ~$50M annualised by April 2026 (secondary, **unverified** [67]; the nearest checkable figure is Sacra's estimate of ~$42M ARR for v0 as of February 2025); Vercel's June 17, 2026 Ship event added an agent framework and AI SDK 7 ([68]) |
...
- **Governance and business.** "stewarded by the OpenClaw Foundation, an independent 501(c)(3)" and "has no paid tier, hosted service, or token" ([69]). Steinberger joined OpenAI on February 15, 2026 to work on personal agents, with Sam Altman saying the project would live in a foundation OpenAI would support ([73], [74]); the foundation was announced July 8, 2026 (secondary, [75]).
- **Model-provider shock.** From April 4, 2026 (12:00 PT) Anthropic stopped Claude Pro and Max subscribers from routing plan usage through third-party harnesses such as OpenClaw; API keys and pay-as-you-go "extra usage" billing still worked (TechCrunch, April 4, 2026 [99]; [76]). On May 13, 2026 Anthropic announced a partial reversal: from June 15, 2026 every paid plan includes a monthly pool of "Agent SDK credits" for programmatic and third-party agent use ($20 on Pro, $100 on Max 5x, $400 on Max 20x); once the pool is spent, such use stops unless the subscriber enables "extra usage" billing at standard API rates (VentureBeat, May 13, 2026 [77]; corroborated by three further secondary write-ups [100]; Anthropic's own pages describing the credits could not be opened).
...
|---|---|---|---|---|
| **Conductor** | macOS app; each agent gets an isolated worktree; review and merge | Claude Code, Codex | Closed | YC S24 (Charlie Holtz, Jackson de Campos); $22M Series A co-led by Spark Capital and Matrix, announced March 31, 2026 by Charlie Holtz ([82], [101]) |
...
| **Symphony (OpenAI)** | Spec plus Elixir reference: watches a Linear board, spawns one isolated run per issue, demands "proof of work" (CI status, review feedback, walkthrough videos), lands PRs | Codex | Apache-2.0, ~27k; "low-key engineering preview" | Repository created February 26, 2026 with first public commits on March 4, 2026, announced April 27-28, 2026; OpenAI said engineers could manage only three to five sessions before context switching hurt, and some teams saw a 500% rise in landed PRs (secondary) ([89], [90], [91]) |
...
- Harness design measurably changes outcomes with the same model: pi's context-per-turn result (Databricks benchmark, corroborated via search excerpts, [98]) and Composer 2's cost story both argue that the harness, not the model, sets cost and throughput once models are good.
...
- Model providers set the rules. Anthropic's April 4, 2026 policy on subscriptions cut off OpenClaw-style harnesses until the June 15, 2026 Agent SDK credits reinstatement; Cursor's "own model" turned out to depend on Moonshot's licence; Warp's open-source project is sponsored by OpenAI. Independence is partial.
...
1. Resolved: SpaceX's $60B all-stock acquisition of Cursor was announced June 16, 2026 and closed August 14, 2026 (see the verification notes).
2. Cline's $32M (seed plus Series A, July 2025), Kilo's $8M seed (December 2025) and Conductor's $22M Series A (March 31, 2026) are now corroborated by two or more independent sources each; Augment's funding totals, Replit's mid-2026 ARR and v0's revenue remain unverified.
3. Resolved: the reinstatement was announced May 13, 2026 and took effect June 15, 2026 through monthly "Agent SDK credits", with "extra usage" billing beyond them; Anthropic's own pages describing the credits could not be opened, so the mechanics rest on secondary write-ups.
4. The Databricks benchmark favouring pi has a primary publication (Databricks Engineering blog, plus Earendil's write-up), but neither could be opened from this environment; the figures rest on search excerpts.
...
45. GitHub, sst/opencode README, https://github.com/sst/opencode (accessed September 2026; the repository now lives at https://github.com/anomalyco/opencode).
46. GitHub, sst/opencode releases, https://github.com/sst/opencode/releases (September 2026; now https://github.com/anomalyco/opencode/releases).
...
48. GitHub, earendil-works/pi (formerly badlogic/pi-mono; the old URL redirects) README, https://github.com/earendil-works/pi (accessed September 2026).
...
51. GitHub, earendil-works/pi releases, https://github.com/earendil-works/pi/releases (September 2026).
...
58. GitHub, qodo-ai/pr-agent, https://github.com/qodo-ai/pr-agent (accessed September 2026; now hosted at The-PR-Agent/pr-agent and, per its README, being donated to an open-source foundation).
...
95. SpaceX-Cursor: CNBC, "SpaceX to acquire the AI coding startup Cursor for $60 billion", https://www.cnbc.com/2026/06/16/spacex-spcx-cursor-acquisition-ipo.html (June 16, 2026); Yahoo Finance, "SpaceX completes record $60 billion acquisition of AI coding platform Cursor", https://finance.yahoo.com/technology/ai/articles/spacex-completes-record-60-billion-131311785.html (August 2026); SatNews, "SpaceX Finalizes Regulatory Procedures to Close $60 Billion Acquisition of AI Platform Cursor", https://satnews.com/2026/08/13/spacex-finalizes-regulatory-procedures-to-close-60-billion-acquisition-of-ai-platform-cursor/ (August 13, 2026); Techzine, "SpaceX completes acquisition of Cursor", https://www.techzine.eu/news/devops/143619/spacex-completes-acquisition-of-cursor/ (August 2026). All read via search excerpts; none could be opened from this environment.
96. CNBC, "Former GitLab CEO raises money for Kilo to compete in crowded AI coding market", https://www.cnbc.com/2025/12/10/former-gitlab-ceo-raises-8-million-for-kilo-to-compete-in-vibe-coding.html (December 10, 2025); FinSMEs, "Kilo Code Raises $8M in Seed Funding", https://www.finsmes.com/2025/12/kilo-code-raises-8m-in-seed-funding.html (December 2025). Read via search excerpts.
97. Cline, "Cline Raises $32M Building the Open-source AI Coding Agent that Enterprises Trust", https://cline.bot/blog/cline-raises-32m-series-a-and-seed-funding-building-the-open-source-ai-coding-agent-that-enterprises-trust (July 2025; unreachable here); FinSMEs, "Cline Raises $32M in Seed and Series A Funding", https://www.finsmes.com/2025/07/cline-raises-32m-in-seed-and-series-a-funding.html (July 2025). Read via search excerpts.
98. Databricks Engineering blog, "Benchmarking Coding Agents on Databricks' Multi-Million Line Codebase", https://www.databricks.com/blog/benchmarking-coding-agents-databricks-multi-million-line-codebase (2026; unreachable here); Earendil, "Pi, Minimal and Performant", https://earendil.com/posts/pi-autoresearch-and-databricks/ (2026; unreachable here); ZenML LLMOps Database, "Pi / Databricks: Minimal Coding Agent Harness Architecture for Cost-Effective LLM Deployment", https://www.zenml.io/llmops-database/minimal-coding-agent-harness-architecture-for-cost-effective-llm-deployment (unreachable here); El Solitario, "Minimalist Pi Harness: Why It Beats Claude Code and Codex", https://elsolitario.org/en/2026/08/05/pi-minimalist-harness-databricks-benchmark/ (August 5, 2026; unreachable here). Read via search excerpts.
99. TechCrunch, "Anthropic says Claude Code subscribers will need to pay extra for OpenClaw usage", https://techcrunch.com/2026/04/04/anthropic-says-claude-code-subscribers-will-need-to-pay-extra-for-openclaw-support/ (April 4, 2026; read via search excerpt).
100. iblnews, "Anthropic Will Reinstate in June 15 OpenClaw and Third-Party Agent Usage on Claude Subscriptions", https://iblnews.org/story/anthropic-will-reinstate-in-june-15-openclaw-and-third-party-agent-usage-on-claude-subscriptions (May 2026); SunMarc App Labs, "Claude Agent SDK Credits Turn Agent Usage Into a Real Budget", https://www.sunmarcs.com/blog/anthropic-claude-agent-sdk-credits.html (2026); Explosion, "Anthropic Brings Back Third-Party Agent Access for Claude - With a Credit Catch", https://www.explosion.com/185825/anthropic-brings-back-third-party-agent-access-for-claude-with-a-credit-catch/ (2026). All read via search excerpts; none could be opened.
101. Charlie Holtz on X, Conductor Series A announcement, https://x.com/charlieholtz/status/2039027121901957349 (March 31, 2026; date decoded from the tweet id); Dealroom, "Conductor raises $22M Series A from Spark and Matrix for AI coding platform", https://app.dealroom.co/news/feed/conductor-raises-22m-series-a-from-spark-and-matrix-for-ai-coding-platform (2026; unreachable here).

## Verification notes (2026-09-08)

Method. GitHub repository metadata, README and release pages were read directly (github.com, raw.githubusercontent.com and the GitHub search API; api.github.com itself returned 403 for repositories not attached to this session). Anthropic's code.claude.com documentation was read directly. Every other 2026 claim was checked against search-engine excerpts, because the network proxy blocked the primary pages (listed below). A claim resting on excerpts only was called confirmed when at least two independent excerpts agreed. The web-search allowance ran out at the end of this pass, so a handful of lower-stakes dates were left unchecked (row 33).

### Claims checked

| # | Claim | Verdict | Evidence and notes |
|---|---|---|---|
| 1 | SpaceX acquired Cursor (Anysphere) for $60B; announced June 16, 2026; closed August 14, 2026 | Confirmed (was marked unverified) | CNBC (June 16, 2026), Yahoo Finance (announcement and completion pieces), SatNews (August 13, 2026), Techzine and Motley Fool (June 29, 2026) excerpts agree: $60B all-stock, announced June 16 days after SpaceX's IPO, closed August 14, roughly 391 million Class A shares, Cursor a wholly owned subsidiary. None of the pages could be opened. |
| 2 | Anthropic barred third-party harnesses from Pro/Max plan usage on April 4, 2026 | Confirmed | TechCrunch (April 4, 2026), TNW, VentureBeat and Hacker News excerpts; enforcement from 12:00 PT; API keys and pay-as-you-go extra usage remained available. |
| 3 | Reinstatement date and mechanics | Corrected | Announced May 13, 2026 (@ClaudeDevs, reported by VentureBeat) and effective June 15, 2026: monthly "Agent SDK credits" ($20 Pro, $100 Max 5x, $400 Max 20x) for programmatic and third-party agent use, with "extra usage" billing at API rates once the pool is spent. The draft presented "extra usage" as the reinstatement itself and left the date open. Corroborated by VentureBeat, iblnews, SunMarc, Explosion and openclawlaunch excerpts. Anthropic's own pages describing the credits were unreachable; the reachable Agent SDK docs still carry a general note that third-party developers may not offer claude.ai login or rate limits without approval, and the Claude Code cost docs describe "usage credits" (the support article is titled "Extra usage for paid Claude plans") as the overflow mechanism. |
| 4 | Cline raised $32M from Emergence Capital | Confirmed, clarified | Combined seed and Series A co-led by Emergence Capital and Pace Capital, announced July 2025 (FinSMEs; Emergence and Saoud Rizwan LinkedIn posts; Cline blog title). |
| 5 | Kilo raised an $8M seed; co-founded by Sid Sijbrandij | Confirmed, clarified | December 10, 2025; led by Cota Capital with Breakers, General Catalyst, Quiet Capital and Tokyo Black; co-founders Scott Breitenother (CEO) and Sijbrandij (CNBC, HackerNoon, FinSMEs, TechStartups). |
| 6 | Conductor $22M Series A, March 2026 | Confirmed | Charlie Holtz's announcement tweet (id decodes to March 31, 2026), Dealroom, Spark's Nabeel Hyatt on LinkedIn; co-led by Spark Capital and Matrix (Ilya Sukhar joined the board). |
| 7 | Augment: $270M round, $472M total | Unverified | Confirmable: $227M Series B at $977M post-money (April 2024; $252M total then, Augment blog). Dealroom reports a later $200M round at a $1.4B valuation (date not visible). The $270M/$472M pair matches no source found. |
| 8 | Cognition $492M ARR | Confirmed | TechCrunch (May 27, 2026) and TNW: $492M annualised revenue, up from $37M a year earlier, alongside the $1B raise at $25B pre-money / $26B post-money. |
| 9 | Replit $400M at $9B (March 2026); $240M ARR | Confirmed | Series D led by Georgian, announced March 11, 2026 (Replit announcement page, TechStartups, Built In SF); $240M ARR was the figure given at the raise, with a $1B target for end-2026. |
| 10 | Replit ~$525M ARR mid-2026 | Unverified | No source found within the remaining budget. |
| 11 | v0 ~$50M annualised by April 2026 | Unverified | No source found; Sacra's estimate is ~$42M ARR as of February 2025 (about 21% of Vercel revenue); Vercel reported $340M ARR in February 2026. |
| 12 | Bolt ~$40M ARR in its first months | Confirmed | $40M ARR reached in March 2025, five months after the October 3, 2024 launch (Sacra, Indie Hackers, Product Growth excerpts). |
| 13 | Databricks benchmark favouring pi | Confirmed via excerpts (was marked unverified) | A primary publication exists: Databricks Engineering, "Benchmarking Coding Agents on Databricks' Multi-Million Line Codebase", plus Earendil's "Pi, Minimal and Performant". ZenML, El Solitario (August 5, 2026), explainx and StartupHub excerpts agree: highest pass rate for pi on the top Anthropic model (named Claude Opus 4.8 at "xhigh" effort in the excerpts), more than 2x lower cost per task in some comparisons, roughly 3x less context per turn, fewer runs. None of the pages could be opened. |
| 14 | Terragon shut down (January 2026) | Confirmed | terragon-oss README read directly: snapshot "at the time of shutdown", dated January 16, 2026; Terragon docs "Shutdown" page and devboxer excerpts: service ended February 9, 2026. |
| 15 | Bloop killed Vibe Kanban (April 2026) | Confirmed, nuanced | "Goodbye bloop" post of April 10, 2026 (Louis Knight-Webb's tweet id decodes to April 10, 2026): the company shut down, hosted services were sunset after 30 days, the project was handed to the community. README banner "Vibe Kanban is sunsetting"; last release v0.1.44 on April 24, 2026; 28.0k stars. |
| 16 | Roo Code shut its extension on May 15, 2026 for a Slack-first cloud agent | Confirmed | README: "The Roo Code Extension was shut down on May 15th"; repository archived May 15, 2026 (24.3k stars); final commits remove the web app and redirect roocode.com to roomote.dev; The New Stack and Kilo excerpts describe the Roomote pivot and "IDEs aren't the future" reasoning; 3 million installs cited. |
| 17 | Roo Code announced the sunset on April 20, 2026 | Corrected | The "sunsetting Roo Code extension, cloud and router" blog post (PR #12160) was merged April 21, 2026; text now says April 21. |
| 18 | Cursor absorbed Continue (June 2026) | Confirmed, date hedged | Disclosed mid-June 2026 (The New Stack, Dealroom, Bodega One, Cyber Ivy excerpts; The New Stack unreachable, so the June 16 day is reported, not confirmed). Repository read-only (35.8k stars); final tags v2.0.0-vscode and v2.1.0-vscode on June 19, 2026; Hub and data export ended July 15, 2026. |
| 19 | Amp dropped ad-supported coding (March 2026) | Confirmed | Ad-supported Amp Free launched October 2025 (Tessl, HackerNoon, Hacker News); ads removed March 2026 (ampcode.com "Amp Free Is Ad-Free" excerpt plus secondary write-ups). |
| 20 | Amp's $10M+ ad run rate and the quoted reason | Unverified | ampcode.com blocked; no independent excerpt repeats the figure or the quote. Marked "(unverified)" in the text. |
| 21 | GitHub stars: OpenClaw ~389k, Hermes ~243k, pi ~103k | Confirmed | GitHub API on 2026-09-08: openclaw/openclaw 389,229 stars and 81,787 forks; NousResearch/hermes-agent 243,396; earendil-works/pi 103.1k (repository page). Also confirmed: opencode 205,923 (now anomalyco/opencode), Cline 67,672, Zed 89,962, Kilo 27,225, OpenHands 86,897 (SDK 1,070), Aider 48,833, Warp 64,884, NanoClaw 30,724, Symphony 27,102, Superset 13,940, Claude Squad 8,450, Auggie 279, PR-Agent 12.9k (now The-PR-Agent/pr-agent), bolt.new 16,539, Roo Code 24.3k, Continue 35.8k, Vibe Kanban 28.0k. |
| 22 | Cognition $1B at $26B (May 2026); $40B talks (August 2026) | Confirmed | TechCrunch May 27 and August 12, 2026; TNW; led by Lux, General Catalyst and 8VC. |
| 23 | Lovable $400M at $13.3B (August 12, 2026); $500M ARR in June | Confirmed | TechCrunch, Bloomberg, TechNode, Dealroom excerpts; led by Menlo Ventures and the Scaleup Europe Fund, with Tencent participating. |
| 24 | Factory $150M Series C at $1.5B (April 16, 2026) | Confirmed | Factory news page title, Crowdfund Insider, TFN, Enterprise DNA excerpts; led by Khosla with Sequoia, Blackstone and Insight; total funding about $220M. |
| 25 | Qodo $70M Series B (March 30, 2026), $120M total | Confirmed | GlobeNewswire, TechCrunch, Calcalist, FinSMEs excerpts; led by Qumra Capital. |
| 26 | Composer 2 built on Kimi K2.5; confirmed March 22, 2026 | Confirmed | TechCrunch (March 22, 2026), eWeek, Trending Topics: model id kimi-k2p5-rl-0317-s515-fast, Lee Robinson's "only ~1/4 of the compute" statement, Moonshot calling it an authorised commercial partnership. One secondary source dates the launch March 18 rather than 19; the text now says March 18-19. |
| 27 | Earendil acquired pi (April 2026) | Confirmed | April 8, 2026 (Earendil press release, Armin Ronacher's post, Agent Wars); the repository now lives at earendil-works/pi with packages under @earendil-works; the "May 2026" timing of the move remains secondary. |
| 28 | Steinberger joined OpenAI (February 2026); OpenClaw Foundation announced July 8, 2026 | Confirmed | TechCrunch and CNBC (February 15, 2026; the announcement is dated February 14 in some accounts); foundation announced July 8, 2026 (OpenClaw blog title, The New Stack, explainx). README read directly: "stewarded by the OpenClaw Foundation, an independent 501(c)(3)", "has no paid tier, hosted service, or token". |
| 29 | Warp open-sourced under MIT / AGPL v3 with OpenAI as founding sponsor | Confirmed | warpdotdev/warp README read directly: warpui crates MIT, the rest AGPL v3; "OpenAI is the founding sponsor of the new, open-source Warp repository, and the new agentic management workflows are powered by GPT models"; 64.9k stars. The April 28, 2026 date rests on the Warp newsroom URL. |
| 30 | Symphony's first commits were on March 27, 2026 | Corrected | Repository created February 26, 2026 (API); the earliest commit on main is dated March 4, 2026 and nothing precedes March 3. The April 27-28, 2026 announcement stands. |
| 31 | Release dates quoted in the text | Confirmed | OpenClaw 2026.9.3 (September 8, 2026); Hermes v0.21.1 (September 7, 2026) and v0.21.0 "Pantheon" (August 31, 2026); pi v0.85.1 (September 5, 2026); opencode v1.18.29 (September 4, 2026); Vibe Kanban v0.1.44 (April 24, 2026); Aider v0.86.0 (August 9, 2025; v0.86.2 is not on GitHub releases, PyPI not checked). Cline's Desktop v0.0.23 (Hub, ~/.agents/plugins, scheduled runs, ClinePass) and Kilo's Agent Manager notes (worktree sessions, grouped PR checks) are current-year releases, which settles open question 9. |
| 32 | Zed 1.0 shipped April 29, 2026 with parallel agents and "Zed for Business" | Unverified (tag date confirmed) | Tag v1.0.0 exists and is dated April 29; its notes cover bookmarks, git, terminal and agent model additions but not parallel agents or Zed for Business, which remain secondary claims. |
| 33 | Cursor 3 on April 2, 2026; Devin Desktop on June 2, 2026; OpenHands' $18.8M Series A; Hermes' February 2026 release; whether Roomote has shipped | Unverified (not checked) | Search budget exhausted and the vendor domains are blocked; left as the author's secondary attributions. |

Tally: 24 confirmed, 3 corrected, 6 unverified (row 33 groups five unchecked items).

### Corrections and updates made in the text

- Status line changed to "verified with notes".
- SpaceX-Cursor: "unverified" removed; the June 16 announcement and August 14 closing added to the Cursor section, the TL;DR and open question 1; source [95].
- Anthropic policy: the OpenClaw section, TL;DR and thesis section now give the April 4 block, the May 13 announcement, the June 15 effective date, the Agent SDK credit amounts and the extra-usage overflow; open question 3 marked resolved; sources [99], [100].
- Cline, Kilo and Conductor funding: "reported"/"unverified" removed; round structure, leads and dates added; open question 2 updated; sources [96], [97], [101].
- Cognition ARR attributed to TechCrunch and TNW; the Replit row gives the Series D date and lead and separates the confirmed $240M from the unverified $525M; the Bolt row is dated to March 2025; the v0 row keeps "unverified" and cites the nearest checkable estimate; Augment stays unverified with the confirmable 2024 figures added.
- Databricks/pi: "unverified" replaced by the primary publication reference and the excerpt-based figures; open question 4 updated; the thesis section wording adjusted; source [98].
- Roo Code announcement date April 20 changed to April 21, 2026; Continue's acquisition date hedged to mid-June with the June 19 final tags and July 15 Hub shutdown; the Vibe Kanban row and TL;DR note the community hand-over; Symphony's first-commit date corrected; Composer 2's launch day flagged; Amp's $10M run rate and quote marked unverified; the OpenClaw README quotation corrected; sources [45], [46], [48], [51] and [58] updated for repository moves.

### Sources that could not be opened

cursor.com, cnbc.com, finance.yahoo.com, techcrunch.com, thenewstack.io, venturebeat.com, databricks.com, earendil.com, zenml.io, elsolitario.org, startuphub.ai, dealroom.co, sacra.com, hn.algolia.com, news.ycombinator.com, vibekanban.com, steipete.me, lucumr.pocoo.org, openclaw.ai, iblnews.org, sunmarcs.com, digitaltoday.co.kr, roborhythms.com, cline.bot, support.claude.com, and the vendor domains already listed in open question 10. For these, the verdicts above rest on two or more independent search excerpts, as stated in each row.

### Remaining doubts

- The Databricks figures (model name, cost ratio) come from excerpts of pages that could not be read; the "Claude Opus 4.8" designation in particular should be checked against the Databricks post before it is quoted elsewhere.
- Anthropic's reachable documentation does not describe Agent SDK credits; the mechanics rest on secondary write-ups of the May 13 announcement.
- Whether Roomote has shipped, and whether opencode's Zen sign-ups remain paused, could not be determined.
- Augment's total funding and v0's revenue have no confirmable 2026 figures.
